...
@WebServlet(name = "Servlet4", value = "/update")
public class updatenote extends HttpServlet {
    private int idnote;

    private void setIdnote(int idnote) {
        this.idnote = idnote;
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String editdatetime =instant.toString();
        ...
        note_service note_service =new note_service();
         ...
         notemodel notemodel;
            ...
            note_service.updatenote(content,notename,editdatetime,idnote);
            notemodel=   note_service.getnotebyid(idnote).get(0);

        String nname = notemodel.getNotename();
        String ct = notemodel.getContent();
        String time = notemodel.getTime();
        String edittime = notemodel.getEdittime();

        out.println(" <div class=\"note\"id=\""+id1+"\">\n" +
                "            <div class=\"manct\">\n" +
